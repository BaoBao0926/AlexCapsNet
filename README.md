...
In this section, we want to explore the effect of the reconstruction model. We use CapsNet and AlexCapsNet with and without the reconstruction module to evaluate it. The data (**Accuracy** is used as evaluation metric) is shown in the following table:
